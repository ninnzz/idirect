                ...
                collection.find(
                    {   location :
                        ...
                        if(results.length > 0) {
                            ...
                            tropo.transfer(['sip:'+results[0].data[0].contact_number[0]+'@sip.tropo.net','sip:21581150@sip.tropo.net'], {playvalue: "http://www.phono.com/audio/holdmusic.mp3", terminator : "*", from: "ShakeCast"});
